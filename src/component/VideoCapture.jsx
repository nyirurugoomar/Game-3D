  ...
  return (
    ...
    <div className='h-full w-full'>
        <div className='md:grid '>
            <div className='md:text-center md:mx-10  '>
                <h1 className='text-white text-[35px] font-Poppins font-[600] md:text-center  '>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h1>
            </div>
