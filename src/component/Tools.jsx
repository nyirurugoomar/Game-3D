    ...
    <div className='w-full h-screen mt-20 mb-20  md:bg-tool-background  bg-cover  '>
        <div className='md:grid max-w[1340px] m-auto md:mx-10 '>
         <div className='text-center md:mx-20 md:mt-20'>
             ...
             <p className='text-white md:mx-20  mt-4 md:text-[16]  font-thin ' width='30rem'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
         </div>
         <div className='grid md:grid-cols-4 lg:grid-cols-4 gap-8 mt-12'>
